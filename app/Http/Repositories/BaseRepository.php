...
abstract class BaseRepository extends \Prettus\Repository\Eloquent\BaseRepository
{
            ...
            if (isset($model) &&
                ...
                switch ($methodClass) {
                    ...
                    case 'Illuminate\Database\Eloquent\Relations\HasMany':
                        ...
                        list($temp, $model_key) =
                            explode('.', $model->$key($key)->getQualifiedForeignKeyName());
    ...
    public function findByFieldWithOperator(
        $field1,
        $operator,
        $field2,
        $field3,
        ...
        $this->applyScope();
        $model = $this->model
            ->whereColumn($field1, $operator, $field2)
            ->where($field3, '=', $value3)->get($columns);
        $this->resetModel();
